...
LOCAL_CFLAGS += -O2 -I$(LOCAL_PATH)/shadowsocksr-libev/libcork/include \
...
LOCAL_CFLAGS += -I$(LOCAL_PATH)/shadowsocksr-libev/libipset/include \
...
LOCAL_CFLAGS += -O2 -I$(LOCAL_PATH)/shadowsocksr-libev/libudns \
...
LOCAL_CFLAGS    := -Wall -fno-strict-aliasing -DMODULE_LOCAL \
					...
					-I$(LOCAL_PATH)/include/shadowsocksr-libev \
					-I$(LOCAL_PATH)/include \
					...
					-I$(LOCAL_PATH)/libev \
					-I$(LOCAL_PATH)/shadowsocksr-libev/src
